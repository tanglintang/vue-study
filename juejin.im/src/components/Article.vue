<template id="Article">
    <div class="app">
        <div class="">
            <div class="article" v-for="article of articleList">
                <div class="row meta-row">
                    <span class="block hot">{{article.hot}}</span>
                    <span class="block author">{{article.author}}</span>
                    <span class="block time">{{article.time}}</span>
